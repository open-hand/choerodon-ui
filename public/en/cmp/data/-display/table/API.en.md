...
| loading | Loading status of table | boolean\|[object](/zh/cmp/feedback/spin/#API) | `false` |
...
| filterTitle | Title of this column for filterBar selection. Prop `title` of this.column as default to this prop `filterTile`. | string\|ReactNode | - |
...
More about pagination, please check [`Pagination`](/zh/cmp/navigation/pagination/).
