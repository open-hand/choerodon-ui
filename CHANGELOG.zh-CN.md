...
- 🌟 `configure`: 新增 autoInsertSpaceInButton, attachment.getTemplateDownloadUrl, autoCount, countKey, drawerHeaderFooterCombined, colorPreset, uploadShowReUploadIcon 属性, generatePageQuery 钩子新增 totalCount, count, onlyCount, defaultCount 参数。
