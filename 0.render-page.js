...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  var _getRequiredData = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "badge"),
      ...
      padding = _getRequiredData.padding,
      pNumberHeight = _getRequiredData.pNumberHeight;

  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), bgColor, fontColor, fontSize, height, height - 0.02, radius, pNumberHeight, bgColor, dotSize, dotSize, padding);
});
...
var getMainStyle = function getMainStyle(props) {
  ...
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), primary, primary);
};
...
function getButtonStyle(props) {
  var _getRequiredData = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "button"),
      ...
      linktextDecoration = _getRequiredData.linktextDecoration,
...
function getDatePickerStyle(props) {
  ...
  var color = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), color.primary, color.primary, color.primary, color.primary, input.inputHeight - input.borderWidth * 2, textAlign, fontSize, textAlign, textCenter, icon, iconSize, iconSize, iconSize / 2, input.inputHeight - input.borderWidth * 2, icon, iconSize, iconSize, iconDateSize, iconSuffixColor, iconContent);
}
...
var MenuStyle = function MenuStyle(props) {
  ...
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), primary, primary, primary, fontFamily, fontSize, fontColor, primary, primary, arrowRightDistance, arrowWidth, arrowHeight, primary, primary, arrowRightDistance, arrowWidth, arrowHeight, arrowColor, arrowColor, primary, primary, primary, primary, primary, primary, primary);
};
...
var ModalStyle = function ModalStyle(props) {
  var _getRequiredData = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "modal"),
      ...
      titlePaddingLeft = _getRequiredData.titlePaddingLeft,
...
var PopconfirmStyle = function PopconfirmStyle(props) {
  ...
  var colors = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), colors.primary, boxShadow, wrapBgColor, wrapRadius, fontFamily, fontSize, textColor, c7nIconSize, iconBgImage, buttonRadius, leftButtonBorderColor, leftButtonColor, leftButtonBorderWidth, buttonPadding, leftButtonBorderColor === "" ? primary : leftButtonBorderColor, leftButtonColor === "" ? primary : leftButtonColor, primary, rightButtonBorder, rightButtonColor, rightButtonBgColor, wrapBgColor);
};
...
var selectDropdown = function selectDropdown(props) {
  ...
  var colors = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject3(), paddingTopPopup, colors.primary, colors.primary, _utils__WEBPACK_IMPORTED_MODULE_3__["getDropdownItemCss"], noShadow ? "none" : "", rightItemHeight, columnGap, columnBorder, columnShadow, (itemHeight - 0.22) / 2, fontFamily, hoverBgColor, activeBgColor, activeFontWeight);
};
...
var StyledSpin = function StyledSpin(props) {
  ...
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject2(), d.size, d.size, d.circleColor, d.fillColor, d.circleColor, d.circleColor, likeRotate, likeRotate, likeRotate, likeRotate, likeRotate, likeRotate, likeRotate, likeRotate);
};
...
function getSwitchStyle(props) {
  ...
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), d.switchHeight, d.switchHeight, d.switchWidth, d.radius, d.switchBg, d.offEnableImage, d.handleRadius, d.handleWidth, d.handleHeight, d.marginTop, d.switchPadding, d.switchOnBg, d.switchOnPadding, d.onEnableImage, d.switchOnButtonBg);
}
...
function getTabsStyle(props) {
  ...
  var colors = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), d.barBottomBorder, d.showInkBar ? "" : "none", colors.primary, d.tabFontSize, d.tabPadding, d.tabMargin, d.tabFontSize, d.tabFontColor, d.tabBorderWidth, d.tabBorderColor, d.showLeftBorder ? "" : "none", d.hideBottomScale ? "none" : "block", colors.primary, d.tabFontSize, d.tabPadding, d.tabMargin, d.tabFontSize, d.tabFontColor, d.tabBorderWidth, d.tabBorderColor, d.showLeftBorder ? "" : "none", d.activeFontColor, d.tabActiveBorderColor, d.tabBorderWidth ? "-".concat(d.tabBorderWidth, "rem 0 0 0 ").concat(d.tabActiveBorderColor) : "", d.hideBottomScale ? "none" : "block", colors.primary, d.tabRadius, d.tabRadius, d.tabBorderWidth, d.tabBorderColor, d.tabRadius, d.tabRadius, d.activeFontColor, d.tabActiveBorderColor, d.tabBorderWidth ? "-".concat(d.tabBorderWidth, "rem 0 0 0 #1890ff") : "");
}
...
function getStyle(props) {
  var colors = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), colors.primary);
}
...
function getTimePickerStyle(props) {
  ...
  return timeChange ? Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject2(), icon, iconSize, iconSize, iconDateSize, iconSuffixColor, iconContent) : "";
}
...
function getDropDown(props) {
  ...
  var colors = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject3(), colors.primary, colors.primary, d.dropDownInputHeight, d.columnWidth, d.itemHeight, d.itemFontSize, d.itemFontColor, d.itemHeight, d.selectedBg, d.selectedFontColor);
}
...
var timeLineItem = function timeLineItem(props) {
  ...
  var fontFamily = data.fontFamily,
      ...
      border = data.border,
      originalIcon = data.originalIcon;
  var themeNew = "\n  .c7n-timeline.c7n-timeline.c7n-timeline {\n    overflow: hidden;\n    padding-top: 8px;\n    .c7n-timeline-item {\n      .c7n-timeline-item-head {\n        border: ".concat(border, "rem solid transparent;\n        border-radius: 50%;\n\n        &:not(.c7n-timeline-item-head-blue),\n        &:not(.c7n-timeline-item-head-green),\n        &:not(.c7n-timeline-item-head-red),\n        &:not(.c7n-timeline-item-head-yellow) {\n          border-color: ").concat(blueNodeBorderColor, "!important;\n          background: ").concat(blueNodeBgColor, "!important;\n          background-clip: padding-box !important;\n        }\n        &.c7n-timeline-item-head-blue {\n          border-color: ").concat(blueNodeBorderColor, "!important;\n          background: ").concat(blueNodeBgColor, "!important;\n          background-clip: padding-box !important;\n        }\n        &.c7n-timeline-item-head-green {\n          border-color: ").concat(greenNodeBorderColor, "!important;\n          background: ").concat(greenNodeBgColor, "!important;\n          background-clip: padding-box !important;\n        }\n        &.c7n-timeline-item-head-red {\n          border-color: ").concat(redNodeBorderColor, "!important;\n          background: ").concat(redNodeBgColor, "!important;\n          background-clip: padding-box !important;\n        }\n        &.c7n-timeline-item-head-yellow {\n          border-color: ").concat(yellowNodeBorderColor, "!important;\n          background: ").concat(yellowNodeBgColor, "!important;\n          background-clip: padding-box !important;\n        }\n      }\n      .c7n-timeline-item-tail {\n        border-left: 0.01rem solid #e8ebee;\n        &:first-child {\n          /* height: 0.55rem; */\n          top: -0.15rem;\n        }\n      }\n      .c7n-timeline-item-content {\n        font-family: ").concat(fontFamily, ";\n        font-size: ").concat(fontSize, "rem;\n        line-height: 0.2rem;\n        height: auto;\n        color: ").concat(fontColor, ";\n      }\n      &.c7n-timeline-item-last {\n        .c7n-timeline-item-tail {\n          display: inline-block;\n        }\n      }\n    }\n  }\n  ");
  var themeOriginal = ".c7n-timeline.c7n-timeline.c7n-timeline {\n    .c7n-timeline-item-head-blue {\n      border-color: ".concat(blueNodeBorderColor, ";\n    }\n    .c7n-timeline-item-head-red {\n      border-color: ").concat(redNodeBorderColor, ";\n    }\n    .c7n-timeline-item-head-green {\n      border-color: ").concat(greenNodeBorderColor, ";\n    }\n    .c7n-timeline-item-head-yellow {\n      border-color: ").concat(yellowNodeBorderColor, ";\n    }\n  }\n  ");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), originalIcon ? themeNew : themeOriginal);
};
...
var tooltipStyle = function tooltipStyle(props) {
  var _getRequiredData = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "tooltip"),
      ...
      themeOriginal = _getRequiredData.themeOriginal;

  if (themeOriginal) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), borderRadius, backgroundColor);
  }

  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject2(), fontFamily, fontSize, backgroundColor, borderRadius, border, arrowColor, arrowBorderLeft, arrowBorderBottom, fontColor, lineHeight, fontSize);
};

/* harmony default export */ __webpack_exports__["default"] = (Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject3(), tooltipStyle));
...
var getTreeCheckStyle = function getTreeCheckStyle(props) {
  ...
  if (checkboxPosition === "default") {
    ...
    }, primary, checkboxWidth / 0.16, checkboxDisabledBorder, checkboxDisabledBgColor, checkboxWidth, checkboxMargin, checkboxHeight, checkboxDisabledBorder, checkboxRadius, checkboxDisabledBorder, checkboxDisabledBgColor, checkboxPrimaryColor || primary, checkboxDisabledBgColor, checkboxWidth, checkboxHeight, checkboxDisabledBorder, checkboxRadius, checkboxPrimaryColor || primary);
...
var getAutoCompleteStyle = function getAutoCompleteStyle(props) {
  var _getRequiredData = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "select"),
      ...
      dropdownWrappertop = _getRequiredData.dropdownWrappertop;

  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), dropdownWrapperBorderColor, dropdownWrappertop || "-6px", _utils__WEBPACK_IMPORTED_MODULE_3__["getDropdownItemCss"]);
};
...
var buttonStyle = function buttonStyle(props) {
  ...
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), height, height, leftRightPadding, radius, borderWidth, defaultColor, textBorderColor || defaultBorderColor, textBgColor || defaultBgColor, height, fontFamily, fontSize, fontSize, defaultFlatHoverColor || textHoverBorderColor, textHoverColor || defaultHoverColor, textHoverBgColor || defaultHoverBgColor, textBorderColor || defaultDisabledBorderColor, defaultDisabledColor, textBgColor || defaultDisabledBgColor, defaultColor, defaultBorderColor, defaultBgColor, defaultHoverBorderColor, defaultHoverColor, defaultHoverBgColor, defaultDisabledBorderColor, defaultDisabledColor, defaultDisabledBgColor, textBgColor || primaryBgColor, textColor || primaryColor, textBorderColor || primaryBorderColor, textColor || primaryHoverColor, textHoverBgColor || primaryHoverBgColor, textBorderColor || primaryHoverBorderColor, textBgColor || primaryDisabledBgColor, primaryDisabledColor, textBorderColor || primaryDisabledBorderColor, primaryColor, linkBgColor, linkColor, linkBorderColor, linktextDecoration || "unset", linkHoverColor, linkHoverBgColor, linkHoverBorderColor, linkHoverBoxShadow, linkActiveColor || linkHoverColor, linkActiveBgColor || linkHoverBgColor, linkActiveBorderColor || linkHoverBorderColor, linkActiveBoxShadow || linkHoverBoxShadow, linkDisabledBgColor, linkDisabledBorderColor, linkDisabledColor, primaryBgColor, primaryColor, primaryBorderColor, primaryHoverColor, primaryHoverBgColor, primaryHoverBorderColor, primaryDisabledBgColor, primaryDisabledColor, primaryDisabledBorderColor, textBgColor, textColor, textBorderColor, textHoverColor, textHoverBgColor, defaultFlatHoverColor || textHoverBorderColor, textHoverBoxShadow, textActiveColor || textHoverColor, textActiveBgColor || textHoverBgColor, defaultFlatHoverColor || textActiveBorderColor || textHoverBorderColor, textActiveBoxShadow || textHoverBoxShadow, textDisabledBgColor, textDisabledBorderColor, textDisabledColor, defaultDisabledColor);
};
...
var getStyle = function getStyle(props) {
  var _getRequiredData = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "cascader"),
      ...
      itemHeight = _getRequiredData.itemHeight,
      mutiSelectHeight = _getRequiredData.mutiSelectHeight,
  ...
  var colors = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject2(), _utils__WEBPACK_IMPORTED_MODULE_3__["getSelectArrow"], mutiSelectHeight, noShadow ? "none" : "", colors.primary, rightItemHeight, columnGap, columnBorder, columnShadow, _utils__WEBPACK_IMPORTED_MODULE_3__["getDropdownItemCss"], (itemHeight - 0.22) / 2, singleMenuItemCurrentBg, singleMenuItemCurrentColor, tabBorderColor, tabHeight, tabHeight - 0.02, tabBorderColor, tabActiveBorderColor, getTabStyle(tabActiveBorderColor, tabType));
};
...
function getDatePickerStyle(props) {
  var _getRequiredData = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "datePicker"),
      ...
      iconContent = _getRequiredData.iconContent,
      iconDateSize = _getRequiredData.iconDateSize,
      ulPadding = _getRequiredData.ulPadding,
      suffixPadding = _getRequiredData.suffixPadding,
      suffixWidth = _getRequiredData.suffixWidth;

  var input = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "input");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), input.inputHeight - input.borderWidth * 2, textAlign, paddingLeft, textAlign, input.inputHeight - input.borderWidth * 4, ulPadding, icon, iconSize, iconSize, iconContent, iconSize / 2, suffixPadding, suffixWidth, iconContent, icon, iconSize, iconSize, iconDateSize, iconSuffixColor);
}
...
function getDropdownStyle(props) {
  ...
  var color = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject2(), headFontColor, operationBtnSize, operationBtnSize, operationBorder, operationBtnRadius, operationBtnBgColor || "#ededed", operationBtnSize, color.primary, selectedFontColor, weekendFontColor, weekendFontColor, headFontColor, bodyItemFontSize, hoverBgColor, color.primary, selectedFontColor, color.primary, oldNewDayOpacity, bodyItemWidth, bodyItemHeight, bodyItemFontSize, bodyItemFontColor, bodyItemRadius, footerColor);
}
...
function getFloatStyle(props) {
  var d = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "input");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject4(), d.formInputOtherHeight ? setFromOtherInputStyle(d, d.formInputOtherHeight) : "", setFromInputStyle(d, d.formInputHeight), d.floatLabelWith, d.floatLabelTop, d.floatLabelLeft, d.floatLabelMarginLeft, d.floatLabelMarginTop, d.numberInputButtonHeight, d.floatNumberInputButtonIconVertical, d.floatPrefixLeft, d.floatPrefixPosition, d.floatPrefixTop, d.floatPrefixTransform, d.floatTextAreaPadding, d.floatTextAreaPosition, d.floatTextAreaTop, d.textAndMutiplePaddingTop, d.errorAllBgColor, d.errorFocusBorderbottom, d.groupHelpBackgroundColor, d.groupHelpColor, d.floatMargin || "0 8px 0 0", d.errorTitleColor);
}
...
function setFromOtherInputStyle(d, inputHeight) {
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject6(), inputHeight - d.borderWidth * 2);
} // 设置 input 高度和formInput一致主要满足form中高度自定义


function setFromInputStyle(d, inputHeight) {
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject7(), d.inputPaddingTop, inputHeight - d.borderWidth * 2, d.selectPaddingLeft, d.textAndMutiplePaddingTop, d.mutiplePaddingLeft, inputHeight - 2 * d.borderWidth, d.cursorBackgroundColor, (inputHeight - 2 * d.borderWidth) / 2 - 0.04, d.floatMutipleItemBackground, d.mutipleBorderRadius, d.floatMutipleItemColor, d.mutipleInputPaddingTop, (inputHeight - d.borderWidth * 2) / 2, d.mutipleIconColor, (inputHeight - 2 * d.borderWidth) / 2 - 0.04, d.cursorBackgroundColor, d.mutipleErrorBgColor, d.errorFontColor, d.errorFontColor);
}

/* harmony default export */ __webpack_exports__["default"] = (Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject8(), function (p) {
...
function getInputStyle(props) {
  ...
  var color = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject4(), color.primary, d.numberInputButtonMargin, d.numberInputButtonHeight, d.numberInputButtonTop, d.numberInputButtonRight, d.numberInputButtonHeight, d.numberInputButtonIconHeight, d.numberInputButtonIconBorder, d.numberInputButtonIconColor, d.numberInputButtonIconMargin, d.numberInputButtonIconBorderRight, d.numberInputButtonIconBorderFirstTop, d.numberInputButtonIconBorderLastBottom, d.numberInputButtonIconVertical, d.errorColor, d.errorShadow, d.errorBgColor, d.errorFontColor, d.errorFontColor, d.errorFontColor, d.errorFocusBorder, d.errorTitleColor, d.borderWidthFocused, d.errorFocusBorderbottom, d.radius, d.fontSize, border, shadowStyle, d.radius - d.borderWidth, d.radius, d.labelBackGround || "#fff", d.inputHeight - d.borderWidth * 2, d.inputFontWeight, d.radius, d.fontColor, color.primary, color.multipleColor || color.primary, d.mutipleBorderRadius, sd.mutiSelectItemFontColor, d.PrefixSuffixColor, d.PrefixSuffixColor, d.focusBordertop, d.focusBorderbottom, d.focusBorderleft, d.focusBorderright, d.borderWidthFocused, d.disabledBorderColor, d.disabledBgColor, d.disabledFontColor, d.radius, d.inputHeight - d.borderWidth * 2, d.inputHeight - d.borderWidth * 2, d.radius, d.errorColor, d.errorShadow, d.errorBgColor, d.errorBgColor, d.errorFontColor, d.errorBgColor, d.errorFontColor, d.errorFontColor, d.errorFocusBorder, d.errorTitleColor, d.borderWidthFocused, d.errorFocusBorderbottom, fc.borderColor, fc.bgColor, fc.bgColor, d.inputHeight - 2 * d.borderWidth, sd.mutiSelectItemBg, d.inputHeight - 2 * d.borderWidth - 0.04, sd.mutiSelectItemFontColor, sd.mutiSelectItemFontSize, d.inputHeight - 2 * d.borderWidth - 0.04, d.mutiSelectItemFontColor, d.mutiSelectItemFontSize, d.groupAfterBorder || "none", d.groupAfterpadding || "0", d.groupAfterBackground || "transparent", d.radius, d.radius, d.groupAfterBorder || "none", d.groupAfterpadding || "0", d.groupAfterBackground || "transparent", d.radius, d.radius, d.groupAfterpadding || "0", d.groupAfterBackground || "transparent", d.radius, d.radius, d.radius, d.radius);
}
...
function getIconPickerStyle(props) {
  var _getRequiredData = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "select"),
      ...
      iconPickerIconColor = _getRequiredData.iconPickerIconColor,
      iconPickerIconContent = _getRequiredData.iconPickerIconContent;

  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), iconPickerIconSize, iconPickerIconSize, iconPickerIcon, iconPickerIconContent || "none", iconPickerIconColor);
}
...
var getCardCss = function getCardCss(props) {
  ...
  var color = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), color.multipleColor || color.primary, d.blockBorderRadius, d.blockFontFamily, d.blockFontSize, d.blockColor, d.blockLineHeight, d.fontFamily, d.fontSize, d.color, d.lineHeight, d.fontWeight, color.multipleColor || color.primary, d.blockBorderRadius, d.blockFontFamily, d.blockFontSize, d.blockColor, d.blockLineHeight);
};
...
function getSelectStyle(props) {
  ...
  var _getRequiredData = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "input"),
      ...
      borderWidth = _getRequiredData.borderWidth,
      inputFontWeight = _getRequiredData.inputFontWeight,
      selectMultiplePading = _getRequiredData.selectMultiplePading;

  var _getRequiredData2 = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors"),
      primary = _getRequiredData2.primary,
      multipleColor = _getRequiredData2.multipleColor;

  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), multipleColor || primary, d.mutiSelectItemFontColor, primary, primary, primary, inputHeight - 2 * borderWidth, inputHeight - 2 * borderWidth, d.multiSelectPadding, d.inputSelectHeight + 0.02, d.inputSelectHeight, d.mutiSelectItemBg, inputHeight - 2 * borderWidth - 0.04, inputHeight - 2 * borderWidth - 0.04, selectMultiplePading || "0.02rem 0.04rem", d.mutiSelectItemBorderRadius, inputFontWeight, d.mutiSelectItemFontColor, d.mutiSelectItemFontSize, d.mutiSelectItemFontColor, d.mutiSelectItemIconSize, d.multiSelectPadding, d.multiSelectItemIconMargin, primary, d.selectPopupBorder || "1px solid #ccc", d.fontFamily, d.dropdownItemFontSize, d.activeBgColor, d.activeFontWeight, d.hoverBgColor);
}
...
function getSwitchStyle(props) {
  var d = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "switch");
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), d.switchOnBg, d.switchOnPadding, d.onEnableImage, d.handleWidth, d.switchOnButtonBg, d.switchHeight, d.switchWidth, d.radius, d.switchBg, d.switchPadding, d.switchHeight, d.offEnableImage, d.handleRadius, d.handleWidth, d.handleHeight);
}
...
function getTableCss(props) {
  ...
  var _getRequiredData = Object(_hzero_front_ui_cfg_lib_utils_utils__WEBPACK_IMPORTED_MODULE_2__["getRequiredData"])(props, "colors"),
      primary = _getRequiredData.primary,
      multipleColor = _getRequiredData.multipleColor;
  ...
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject3(), inputHeight - 0.02, d.fontFamily, d.formLabelTextAligin, d.fromLabelVerticalAligin, d.filterBackgroundColor, d.filterBoderRadius, d.filterFontFamily, d.filterFontSize, d.filterColor, d.filterColor, d.filterContent, d.filterChooser, d.filterChooserOverflow, d.filterChooserButtonRadius, d.filterChooserButtonRadius, d.filterSelectButtonborder, d.filterSelectButtonBgColor, d.filterSelectButtonColor, d.filterSelectInputBorder, d.filterSelectInputBorder, d.bordered ? 1 : 0, d.borderColor, d.rowHeight, layout === "vertical" ? inputHeight : "", primary, primary, d.borderColor, getRowBorder(d), d.bordered ? Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject4(), d.borderColor, d.borderColor) : "", d.editableActiveBorderColor, d.tableEditorBeforeRadius, d.tableEditorBeforeDisplay, d.tableEditorBeforeRadius, d.tableEditorBeforeBorder, d.tableEditorborderWidthFocused, d.borderColor, d.expandFontSize, d.expandFontColor, d.expandIconPaddingTop, d.expandContent, d.expandRadius, d.expandIcon, d.expandIconBGColor, d.collapseContent, d.expandedIcon, d.headBg, d.tableHeaderBorderColor || d.borderColor, getRowBorder(d), d.headHeight, d.headHeight, d.headHeight - 0.02, d.headHeight, d.headFontSize, d.headFontColor, d.borderGroupHeaderColor ? d.borderGroupHeaderColor : d.tableHeaderBorderColor || d.borderColor, d.borderGroupHeaderColor ? "1px solid".concat(d.borderGroupHeaderColor) : "none", d.borderGroupHeaderColor ? "1px solid".concat(d.borderGroupHeaderColor) : "none", d.borderGroupHeaderColor ? "1px solid".concat(d.borderGroupHeaderColor) : "none", d.borderGroupHeaderColor ? "1px solid".concat(d.borderGroupHeaderColor) : "none", d.bodyBg, getStripStyle(d), d.currentBordercolor || d.bodyHoverBg, d.currentBordercolor || d.editableActiveBorderColor, d.bodyHoverBg, d.editableActiveBorderColor, getRowBorder(d), d.borderColor, multipleColor || primary, d.rowInputHeight || "0.28rem", d.rowInputHeight || "0.28rem", fc.borderColor, fc.bgColor, errorColor, errorFontColor, errorBgColor, d.rowHeight, borderColor, d.editableBackgroundColor || background, d.rowHeight, d.bodyFontSize, d.bodyFontColor, d.bodyFontWeight, d.iconradius, d.iconBorder, d.iconHeight, d.iconWidth, d.iconBackGround, d.iconFontSize, d.iconLineHeight, d.iconVerticalAlicin, d.iconBackGround, d.editIconColor, d.editIconfontFamily || "iconfont-c7n", d.editIcon || "\\e63b", d.deleteIconColor, d.deleteIconfontFamily || "iconfont-c7n", d.deleteIcon || "\\e624", d.checkIconColor, d.checkIconfontFamily || "icomoon", d.checkIcon || "\\e876", d.deleteIconColor, d.deleteIconfontFamily || "icomoon", d.closeIcon || "\\e5cd");
}
...
var tooltipStyle = function tooltipStyle(props) {
  ...
  if (themeOriginal) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), borderRadius, arrowColor, fontColor, lineHeight, fontSize, arrowColor);
  }

  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject2(), fontFamily, fontSize, backgroundColor, borderRadius, border, arrowColor, fontColor, lineHeight, fontSize);
};
