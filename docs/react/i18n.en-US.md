...
choerodon-ui provides a React Component [LocaleProvider](/components/locale-provider) for configuring choerodon-ui locale text globally.
...
choerodon-ui/pro provides [LocaleContext](/components-pro/locale-context) for configuring choerodon-ui/pro locale text globally.

```jsx
import { localeContext } from 'choerodon-ui/pro';
import en_US from 'choerodon-ui/pro/lib/locale-context/en_US';
