...
import frFR from 'choerodon-ui/lib/locale-provider/fr_FR';
...
If you see logs like below screenshot, you might be importing all components by writing `import { Button } from 'choerodon-ui';`. This will affect your app's network performance.
