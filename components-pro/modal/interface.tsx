...
export type ModalOkAndCancelIconItem = {
  okIconType?: string | boolean;
  cancelIconType?: string | boolean;
}
export type ModalOkAndCancelIcon = undefined | boolean | ModalOkAndCancelIconItem;
