...
describe('Cascader-pro', () => {
  ...
  it('Cascader dataset set value render right number item', () => {
    const handleDataSetChange = jest.fn();
    const lessTreeMock =  [
      {
        expand: false,
    ...
    const wrapper = mount(
      <Cascader dataSet={optionDs} name="user" />,
    );
