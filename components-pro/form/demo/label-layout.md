...
const App = () => {
  ...
  return (
    <Form labelWidth={labelWidth} labelTooltip="overflow" columns={3}>
      <SelectBox colSpan={3} label="labelLayout" value={labelLayout} onChange={setLabelLayout}>
      ...
      <SelectBox colSpan={3} label="labelWidth" value={labelWidth} onChange={setLabelWidth}>
        <Option value={fixedLabelWidth}>固定宽度[60,70,50]</Option>
