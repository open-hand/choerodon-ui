...
const locale: Locale = {
  ...
  Table: {
    ...
    reset_button: 'Reset',
    all_reset_button: 'All reset',
    filter_placeholder: 'Please enter your search',
    query_button: 'Query',
    ...
    ascending: 'Asc',
    descending: 'Desc',
    current_data_sort: 'Current page sort',
    all_data_sort: 'All page sort',
  ...
  Lov: {
    choose: 'Choose',
    selection_tips: '{count} data selected',
    non_conformity_warning: 'This value set does not meet the requirements of the detailed value set specification of the displayable value set value, please contact the system administrator to deal with it!',
  },
  Transfer: {
    items: 'items',
