...
import { ColumnLock, TableHeightType, TableResizeTriggerType } from '../table/enum';
...
export default class TableStore {
  ...
  get tableResizeTrigger(): TableResizeTriggerType {
    return this.getConfig('tableResizeTrigger');
  }
