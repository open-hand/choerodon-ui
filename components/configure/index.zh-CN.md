...
| getTemplateDownloadUrl               | 获取模板下载地址               | ({ bucketName?: string, bucketDirectory?: string, storageCode?:string, url: string, isPublic?: boolean }) => string \| Function \| Promise<string \| Function>                            | |
