...
describe('Table.pagination', () => {
  ...
  it('should have pager when change pagination from false to undefined', () => {
    ...
    expect(wrapper.find('.ant-pagination')).toHaveLength(1);
    expect(wrapper.find('.ant-pagination-total-text').at(0).text()).toEqual('1 - 4 / 4');
  });
  ...
  it('should display pagination as prop pagination change between true and false', () => {
    const wrapper = mount(createTable());
    expect(wrapper.find('.ant-pagination')).toHaveLength(1);
    expect(wrapper.find('.ant-pagination-total-text').at(0).text()).toEqual('1 - 2 / 4');
    ...
    expect(wrapper.find('.ant-pagination')).toHaveLength(1);
    expect(wrapper.find('.ant-pagination-total-text').at(0).text()).toEqual('1 - 4 / 4'); // pageSize will be 10
  ...
  it('change to correct page when data source changes', () => {
    ...
    expect(wrapper.find('.ant-pagination-total-text').at(0).text()).toEqual('1 - 1 / 1');
  });
